...
@section('title', 'Manajemen Tipe Latihan')
@section('page_title', 'Manajemen Tipe Latihan')
...
@section('content')
    ...
    <div class="row g-2 align-items-end mb-3">
        <div class="col-md-8">
            ...
            <input autocomplete="off" id="searchInput" type="text" class="form-control"
                placeholder="Cari nama tipe latihan...">
        </div>
        <div class="col-md-4 text-end">
            <button class="btn btn-add w-100" data-bs-toggle="modal" data-bs-target="#modalTambah">
                <i class="fas fa-plus me-2"></i>Tambah Tipe Latihan
            </button>
        </div>
    </div>
    ...
    <div class="table-responsive table-wrapper">
        <table class="table table-bordered w-100 table-hover text-center align-middle" id="typeTable">
            ...
            <tbody id="typeBody">
                    ...
                    <tr id="row{{ $item->id }}">
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-1">
                                <button class="btn btn-sm-1" onclick="editType('{{ $item->id }}')">Edit</button>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-muted text-center">Belum ada data tipe latihan.</td>
                    </tr>
                @endforelse
            </tbody>
            <tfoot>
        ...
        <div class="modal-dialog">
            <form id="formTambah" class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Tipe Latihan</h5>
                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Masukkan nama tipe latihan"
                            required>
                    </div>
                </div>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form id="formEdit" class="modal-content">
                ...
                @method('PUT')
                <div class="modal-header">
                    <h5 class="modal-title">Edit Tipe Latihan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
                <div class="modal-body row g-3">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.getElementById("formTambah").addEventListener("submit", function(e) {
                ...
                fetch("{{ route('admin.pra_latihan.tipe.store') }}", {
                        method: "POST",
                        headers: {
            ...
            document.getElementById("formEdit").addEventListener("submit", function(e) {
                ...
                fetch(`/admin/pra_latihan/tipe/${id}`, {
                        method: "PUT",
                        headers: {
                            "X-CSRF-TOKEN": "{{ csrf_token() }}",
                            "Content-Type": "application/json"
        ...
        function editType(id) {
            fetch(`/admin/pra_latihan/tipe/${id}/edit`)
                .then(res => res.json())
                .then(result => {
                    if (result.success) {
                        const t = result.data;
